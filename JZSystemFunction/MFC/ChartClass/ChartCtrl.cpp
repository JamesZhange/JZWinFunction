...
COLORREF pSeriesColorTable[] = { RGB(4,119,194), RGB(0,255,255),RGB(128,0,128), RGB(255,0,0), RGB(0,150,0), RGB(0,0,255), RGB(255,255,0), 
								 RGB(255,128,0),  RGB(128,128,0), RGB(255,0,255), RGB(64,128,128)};
